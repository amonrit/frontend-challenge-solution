...
| T5 | Run before/after measurements and final checks. | `solutions.md`, `docs/assessment/104/`, tests | T4 | Same deterministic completion order shows `[3, 4]` before and `[3]` after; full checks pass. | Focused + full suite; analyzer; diff check; runtime log if available | Next |
