...
| T2 | Guard load-more acceptance and page advancement. | `lib/feature/home/home_controller.dart` | T1 | A page-2 response is appended only for the current round and expected page; `_page` advances only when accepted. | Generation plus expected page; compare response page; both checks | Next |
