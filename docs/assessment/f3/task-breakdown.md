...
| E7 | Verify rebuild scope and integrated reservation flows | Focused/widget/integration tests, F-3 docs, profile evidence | E1–E6 | Controlled tests cover add/rollback/races/release/expiry/410; profile/manual evidence states exact device and limitations | Emulator functional flow; physical-device DevTools run | **Next executable task** |
