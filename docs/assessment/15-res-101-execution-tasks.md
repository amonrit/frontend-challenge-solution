...
| E2 | Run and record focused GREEN result for the stale-response test. | test and evidence docs | E1 | `flutter test test/search_deals_controller_test.dart` passes. | Next |
