...
| E3 | Add clear-input regression coverage. | `test/search_deals_controller_test.dart` | E2 | A response that started before clear cannot repopulate results or restore searched state. | Next |
