...
| E6 | Mount the root notice host | App root, notice-host widget, widget/service test | E3 | Each automatic cart removal produces one visible notice without coupling the clock to snackbar calls | Root host; route shell host | **Next executable task** |
