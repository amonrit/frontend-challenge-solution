...
| E7 | Verify 100-countdown rebuild scope and disposal | Focused widget tests, clock instrumentation | E2, E4, E5 | One tick rebuilds countdown leaves only; 100 leaves create no timer-per-widget or post-disposal callback | Build counters; test-only observer instrumentation | **Next executable task** |
