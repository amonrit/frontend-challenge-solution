...
| E8 | Run end-to-end and performance verification | F-1 docs, integration test, profile evidence | E3–E7 | Targeted/full tests, analyzer, Android flow, and comparable DevTools profile evidence meet acceptance criteria | Android emulator functional run; physical-device DevTools profile run | **Next executable task** |
