...
| T3 | Add midnight, month-end, year-end, and device-timezone tests | `test/res_106_pickup_window_test.dart` | T1, T2 | Fixed-clock tests cover Bangkok date boundaries and remain deterministic | Table-driven cases; separate named tests | Next |
