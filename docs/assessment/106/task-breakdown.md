...
| T5 | Run verification and collect before/after evidence | `docs/assessment/106/`, `solutions.md` | T3, T4 | Focused tests, full suite, analyzer, diff check, and evidence all pass and are recorded | Local commands; simulator smoke check if needed | Next |
