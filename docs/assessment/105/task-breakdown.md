...
| T2 | Make the main feed lazy | `lib/feature/home/home_screen.dart`, focused widget test | T1 | Cards are built through a lazy delegate while refresh, pagination, filter, and navigation still work | `ListView.builder`; sliver composition | Next |
