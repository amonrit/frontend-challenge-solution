...
| E7 | Run final functional and performance verification | F-2 docs, integration test, profile evidence | E1–E6 | Targeted/full tests, analyzer, cross-screen flow, batch threshold checks, and comparable profile evidence meet acceptance criteria | Android emulator functional flow; physical-device DevTools profile run | **Next executable task** |
