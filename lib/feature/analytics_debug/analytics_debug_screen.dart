        ...
        children: [
          Obx(() => Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Pending impressions: '
                        '${analytics.pendingImpressionCount.value}'),
                    Text('Sending impressions: '
                        '${analytics.inFlightImpressionCount.value}'),
                    Text(
                        'Delivery: ${analytics.lastBatchError.value != null ? 'retry scheduled' : analytics.isSendingImpressionBatch.value ? 'sending' : 'idle'}'),
                  ],
                ),
              )),
