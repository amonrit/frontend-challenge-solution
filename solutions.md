...
| F-1 | Discovery in progress | Scope recorded; no implementation or runtime evidence | Complete implementation, 100+ countdown performance evidence, and regression coverage |
